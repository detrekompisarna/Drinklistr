...
/**
 Base class for all Drinklistr views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Drinklistr view hierarchy (such as wrapped iOS UIViews) was touched.
