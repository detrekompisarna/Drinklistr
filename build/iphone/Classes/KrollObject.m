...
//@interface DrinklistrObject : NSObject
//@end

@interface DrinklistrObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DrinklistrObject class]])
		{
			for (NSString *key in [[(DrinklistrObject*)o modules] allKeys])
			{
