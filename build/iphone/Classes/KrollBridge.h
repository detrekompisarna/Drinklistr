...
@interface DrinklistrObject : KrollCoverageObject {
#else
@interface DrinklistrObject : KrollObject {
#endif
@private
...
extern NSString * Drinklistr$ModuleRequireFormat;
