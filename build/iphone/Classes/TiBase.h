...
// in simulator we redefine to format for Drinklistr Developer console
...
{\
	NSString * exceptionName = [@"org.drinklistr." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.drinklistr";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDrinklistrNativeItemNone = -1, 
	UIDrinklistrNativeItemSpinner = -2,
	UIDrinklistrNativeItemProgressBar = -3,
	
	UIDrinklistrNativeItemSlider = -4,
	UIDrinklistrNativeItemSwitch = -5,
	UIDrinklistrNativeItemMultiButton = -6,
	UIDrinklistrNativeItemSegmented = -7,
	
	UIDrinklistrNativeItemTextView = -8,
	UIDrinklistrNativeItemTextField = -9,
	UIDrinklistrNativeItemSearchBar = -10,
	
	UIDrinklistrNativeItemPicker = -11,
	UIDrinklistrNativeItemDatePicker = -12,
	
	UIDrinklistrNativeItemInfoLight = -13,
	UIDrinklistrNativeItemInfoDark = -14,
	
	UIDrinklistrNativeItemDisclosure = -15,
	
	UIDrinklistrNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Drinklistr instances of
